...
import com.example.uas_papb.databinding.ActivityDetailaccountBinding
    ...
    override fun onStart() {
        ...
        binding.updateBtn.setOnClickListener {
            ...
            query.get().addOnSuccessListener {
                ...
                if(auth.currentUser!!.photoUrl.toString() == imageUri.toString()) {
                    imageUri = auth.currentUser!!.photoUrl
                }
                val data = User(id = snapshot!!.id, name = fname.text.toString()+" "+lname.text.toString(), profileImage = imageUri.toString(), password = snapshot.password, role = snapshot.role)
                query.set(data)
            }
