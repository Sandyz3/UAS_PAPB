...
class DataViewAdapter(private val mList: List<Item>) : RecyclerView.Adapter<DataViewAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataViewAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: DataViewAdapter.ViewHolder, position: Int) {
